...
<body>
    ...
    <div class="container">
        <div class="row text-center" style="padding-top: 20px;">
            <div class="col-md-4">
                <div class="choix_administration">
                    <a href="administration.php"> <i class="fa fa-print" aria-hidden="true"></i> <br> Validation des relevés de
                        notes
                        et cliniques</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="choix_administration">
                    <a href="soutenances.php"> <i class="fa fa-print" aria-hidden="true"></i> <br> Validation finale
                        des demandes </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="choix_administration"> <a href="asoutenu.php"> <i class="fa fa-calendar" aria-hidden="true"></i> <br> A Soutenu?</a>
                </div>
            </div>
