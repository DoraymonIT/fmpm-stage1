        ...
        <div class="col-md-4">
          <ul class="nav nav-pills nav-justified" id="pills-tab" role="tablist">
            <li class="nav-item">
              ...
              role="tab" aria-controls="pills-home" aria-selected="true"> <i class="fa fa-user-circle" aria-hidden="true"></i>
              Étudiant(e)</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" 
              role="tab" aria-controls="pills-profile" aria-selected="false"> <i class="fa fa-user-md" aria-hidden="true"></i> Professeur(e)</a>
            </li>
            ...
            <div class="col-md-4">
              ...
              <div class="shadow">
                <form action="login-process.php" method="post">
                  ...
                  <br />
                  <button type="submit" name="submit_etudiant" class="btn btn-success btn-custom">Se Connecter</button>
                </form>
              </div>
            </div>
            <div class="col-md-4"></div>
