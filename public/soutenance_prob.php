...
if (mysqli_num_rows($result) == 0) {
    ...
    <section>
        ...
        <input class="datepicker1 form-control form-control-sm" type="date"
               ...
               style="text-align: center;" name="date_depot_sujet" value="<?php echo $soutenance['date_depot_sujet'] ?>"
               disabled required/>
        <br/>
        <label>Directeur de la thèse <span>*</span></label>
        <select class="form-control form-control-sm" name="directeur_these"
                onclick="profSelect(this)" <?php if ($soutenance['etat'] < -2) echo "disabled"; ?> required>
        ...
        <input type="text" name="nature" class="form-control form-control-sm"
               placeholder="Nature de la thèse" value="<?php echo $soutenance['nature_these'] ?>" required/>
        <br/>
        ...
        <textarea name="obj_etude" id="" cols="2" rows="2" class="form-control"
                  placeholder="Objectifs de l’étude" required><?php echo $soutenance['objectif_d_etude'] ?></textarea>
        <br/>
