...
if (soutenanceExistByEtudiant($cne)) {
    $type = 1;
    $soutenance = get_soutenance_by_etudiant($cne);
...
} elseif (theseExistByEtudiant($cne)) {
    $type = 0;
    $these=get_these_by_etudiant($cne);
} else {
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                                        ...
                                        <div class="step-content  rounded lighten-3">
                                            <div class="row">
                                                <form action="soutenance_process.php" method="POST">
                                                    ...
                                                    <button name="valider_date_etudiant" class="btn btn-success p-3"><i
                                                                class="fa fa-check mr-2" aria-hidden="true"></i>
                                                        Valider
                                                    </button>
                                                </form>
                                                <a href="choix_du_date.php" class="btn btn-success p-3"><i
                                                            class="fa fa-clock-o mr-2" aria-hidden="true"></i>
                ...
                ?>
                <ul class="stepper stepper-vertical">
                    <li <?php if ($these['etat'] >= 1 || $these['etat'] < -1) { ?>class="completed">
                        <a href="#" class="disabled">
                            <span class="circle"><i class="fa fa-check"></i></span><?php
                            } elseif ($these['etat'] == 0) {
                            ?>
                    ...
                    <li <?php if ($these['etat'] >= 2 || $these['etat'] < -2) { ?>class="completed">
                        <a href="#" class="disabled">
                            <span class="circle"><i class="fa fa-check"></i></span><?php
                            } elseif ($these['etat'] == -2) {
                            ?>
                            ...
                            <a href="#" class="disabled">
                                ...
                                <a href="#" class="disabled">
                                    ...
                                    <span class="label">Chef Service</span>
                                </a>
                                <?php
                                if ($these['etat'] == -2) {
                                    ?>
                    ...
                    <li <?php if ($these['etat'] >= 3 || $these['etat'] < -3) { ?>class="completed">
                        <a href="#" class="disabled">
                            <span class="circle"><i class="fa fa-check"></i></span><?php
                            } elseif ($these['etat'] == -3) {
                            ?>
