                                    ...
                                    if ($creneau) {
                                        ...
                                        <div class="step-content orange rounded lighten-3">
                                            ...
                                            echo $creneau['jour'] . " | " . $creneau['heure']
                                                . "<br> Lieu Choisie : " . $creneau['lieu'] . "<br> Date reserve jusqu'a le  : " . date('Y-m-d H:i', strtotime($creneau['date_reservation'] . ' + 2 days'));
                                            ?>
                                ...
                                if ($soutenance['etat'] > 5 && $soutenance['etat']!=9) {
                                    ...
                                    if ($creneau) {
                                        ...
                                        <div class="step-content green rounded lighten-3">
                                            <strong>Date de soutenance :</strong><br>
                                            <?php
                                            echo $creneau['jour'] . " | " . $creneau['heure']
                        ...
                        <a href="#" class="disabled">
                            ...
                            <a href="#" class="disabled">
                                ...
                                if ($soutenance['etat'] == 9) {
                                    ?>
                                    <div class="step-content green rounded lighten-3">
                                        <a href="pdf.php?id=<?php echo $soutenance['soutenance_id']; ?>"
                                           class="btn btn-danger p-2 d-flex align-items-center"><i
                                                    class="fa fa-file-pdf mr-2" aria-hidden="true"></i> Attestation</a>
