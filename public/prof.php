...
<section>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <ul class="nav nav-pills nav-justified" id="pills-tab" style="border: 2px solid teal;border-radius: 6px" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link " id="pills-home-tab" data-toggle="pill" href="#president_tab" role="tab"
                           aria-controls="pills-home" aria-selected="true"> <i class="fa fa-user-circle"
                                                                               aria-hidden="true"></i>
                            president<span id="bagde_president" class="badge badge-dark ml-1"><?php echo mysqli_num_rows($result_president) ?></span></a>
                    </li>
                    <span style="padding-left: 2px;"></span>
                    <li class="nav-item" style="margin-right: -4px">
                        <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#directeur_tab" role="tab"
                           aria-controls="pills-profile" aria-selected="false"> <i class="fa fa-user-md"
                                                                                   aria-hidden="true"></i> Directeur<span id="bagde_directeur" class="badge badge-dark ml-1"><?php echo mysqli_num_rows($result_directeur) ?></span></a>
                    </li>
                    <span style="padding-left: 2px;"></span>
