                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr id="row_<?php echo $row['soutenance_id'] ?>" role="tab" >
                                    <td>
                                        ...
                                        <!--                    <button data-toggle="tooltip" data-placement="left" data-html="true"
                                         title="Cliquez Ici pour <b> les relevés de notes</b> et <b>les stages</b> et<b> les cliniques</b> 
                                         de cet étudiant avant de confirmer <b>la validation .</b>" class="btn btn-sm btn-info">-->
